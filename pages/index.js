...
const details = [
  {
    ...
    imgUrl:
      "https://images.unsplash.com/photo-1592595896616-c37162298647?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8",
  },
  {
    id: 2,
    ...
    imgUrl:
      "https://images.unsplash.com/photo-1556912167-f556f1f39fdf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8",
  },
];
  ...
  <Box>
    ...
    <Flex flexWrap="wrap" justifyContent="center" gap={5}>
      {propertiesForRent.map((property) => (
        <Property property={property} key={property.id} renting={true} />
      ))}
    </Flex>
    <Banner
      purpose="BUY A HOME"
