import { chakra, Box, Flex, Text, SimpleGrid, Image } from "@chakra-ui/react";

const TextComponent = ({ item }) => {
  return (
    <Box bg="white" _dark={{ bg: "gray.800" }} pt={10} rounded="md">
...
const ImageComponent = ({ item }) => {
  return (
    <Box bg="white" _dark={{ bg: "gray.800" }} rounded="md" height={320}>
      <Image
        alt={"Hero Image"}
        fit={"cover"}
        align={"center"}
